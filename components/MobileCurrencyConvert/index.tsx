...
const MobileCurrencyConvert = ({ isOpen, finalRef, onClose, price }: any) => {
  ...
  return (
    ...
    >
      <ModalOverlay />
      <ModalContent width={'90vw'} height={'auto'} maxWidth={'100%'}>
        <ModalBody>
          <Flex direction={'column'} alignItems={'center'} height={'inherit'}>
            <Text fontSize={'23px'} lineHeight={'20px'}>
              Amount in USD
            </Text>
          </Flex>
          <Flex
...
export default MobileCurrencyConvert;